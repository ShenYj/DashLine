#
#  Be sure to run `pod spec lint DashLine.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "DashLine"
  spec.version      = "1.0.0"
  spec.summary      = "A simple widget of DashLine."
  ...
  spec.homepage     = "https://github.com/ShenYj/DashLine"
  ...
  spec.source       = { :git => "git@github.com:ShenYj/DashLine.git", :tag => "#{spec.version}" }
